...
export SYSROOT=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk
export WARNINGS=-Wall -Wmost -Wextra -Wno-missing-braces -Wno-trigraphs -Wno-private-extern -Werror
